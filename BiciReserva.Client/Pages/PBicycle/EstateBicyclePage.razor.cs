...
{
    public partial class EstateBicyclePage
    {
        ...
        {
            insert = true;
            var response = await Repository.Delete($"api/v1/StateBicycle/{estado.idEstado}");
        ...
        async Task OnCreateRow(GStateGeneralDTO estado)
        {
            ...
            var response = await Repository.Post<GEstadoDTO, GStateGeneralDTO>("api/v1/StateBicycle", state);
        ...
        {
            insert = true;
            var response = await Repository.Put<GStateGeneralDTO>($"api/v1/StateBicycle", estado);
